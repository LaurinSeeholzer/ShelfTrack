...
<body class="h-full">
    ...
    <div class="bg-gray-900 pb-32">
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <h1 class="text-3xl font-bold tracking-tight text-white">ADD NEW OBJECT</h1>
        </div>
        </header>
    </div>
            ...
            <form method="post" enctype="multipart/form-data" class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div class="">
                    <div>
                        ...
                        <div class="mt-2">
                            <input type="text" name="name" id="name" class="block w-full px-3 py-1.5 rounded-md bg-gray-50 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-200 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-gray-600 sm:text-sm/6" placeholder="Your new object">
                        </div>
                    </div>
                </div>
                <div class="flex gap-x-4">
                    <div class="grow">
                        ...
                        <div class="mt-2">
                            <input type="text" name="object_number" id="object_number" class="block w-full px-3 py-1.5 rounded-md bg-gray-50 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-200 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-gray-600 sm:text-sm/6" placeholder="0000.0000">
                        </div>
                    </div>
                ...
                <div class="sm:col-span-2">
                    <div>
                        ...
                        <div class="mt-2">
                            <textarea rows="4" name="description" id="description" class="block w-full px-3 py-1.5 rounded-md bg-gray-50 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-200 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-gray-600 sm:text-sm/6"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="sm:col-span-2">
                    <div>
                        ...
                        <div class="mt-2">
                            <textarea rows="4" name="defects" id="defects" class="block w-full px-3 py-1.5 rounded-md bg-gray-50 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-200 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-gray-600 sm:text-sm/6"></textarea>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="gap-x-4 w-full flex">
                            <div class="w-full">
                                ...
                                <div class="mt-2 w-full">
                                    <input type="number" name="quantity" id="quantity" class="h-8 w-full px-3 py-1.5 rounded-md bg-gray-50 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-200 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-gray-600 sm:text-sm/6" value="1">
                                </div>
                            </div>
